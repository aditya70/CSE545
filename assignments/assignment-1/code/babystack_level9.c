...
//__asm__ __volatile("pop %rdi");
    ...
    puts("In this challenge, you will need to use libc for your ROP gadgets... but we are not going");
    puts("to give you a leak. You need to get it yourself. To do this, you will need to utilize the");
    puts("functions already in this binary to get yourself a leak to libc, then use libc.\n");
