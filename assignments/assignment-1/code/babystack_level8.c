...
int main(int argc, char **argv, char **envp)
{
    ...
    puts("In this challenge, you will need to get yourself a libc leak using an arbitrary read that");
    puts("we give you. To use this correctly, you will need to understand how linking works.\n");
