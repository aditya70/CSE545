...
int main(int argc, char **argv, char **envp)
{
    ...
    puts("In this challenge set, ROP, you will need to use various methods to jump to functions,");
    puts("pass functions, use libc, and do other various tasks!\n");

    puts("This challenge requires you to use libc in some way. Sadly, ASLR is here to stop you. In");
    puts("real life, and later challs, you would need to leak the address of libc. To simulate this,");
    puts("we will give you a leak to libc:");
    printf("The function \"system\" in libc is located at %p\n\n",dlsym(RTLD_NEXT, "system"));
