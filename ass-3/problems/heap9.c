...
{
    puts("Edit function is not implemented! Surprise!");
    return;
}
...
void delete_chunk(void)
{
    ...
    {
        puts("double free a chunk into tcache is not allowed :)");
        return;
    }
...
void main_func(void)
{
    ...
    puts("This challenge also has a use-after-free-read vulnerability in it.");
    ...
    puts("Sorry, it's not Christmas yet. So no Christmas gift :)");
