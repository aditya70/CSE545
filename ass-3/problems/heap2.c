...
long check_variable = 0;
void check(void)
{
    if(check_variable == 0xdeadbeef) win();
}
...
void main_func(void)
{
    ...
    puts("This challenge has a double free vulnerability in it.");
    ...
    puts("In this challenge, Your goal is to overwrite the `check_variable` global variable with a specific value.");
    puts("After the value is successfully overwritten, you can redeem the flag by invoking the check function");
